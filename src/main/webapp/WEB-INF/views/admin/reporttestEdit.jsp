                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                ...
                                <form:form id="userForm" modelAttribute="reporttestForm"  enctype="multipart/form-data"
                                           action="${pageContext.request.contextPath}/admin/reporttest/update/"
                                    ...
                                    <div>
                                        ...
                                        <div class="col-md-1 col-sm-6 col-xs-12">
                                            <form:input path="sortScore" id="sortScore" class="form-control col-md-7 col-xs-12"
                                                        ...
                                                        value="${reporttestForm.sortScore}"/>
                                        </div>
                                    </div>
                                </div>
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12"  >
                                        ...
                                        <div class="col-md-12 col-sm-12 col-xs-12">
                                            <form:input path="picFile1" id="picFile1"
                                                ...
                                                <%--<c:forEach items="${reporttestForm.picUrl1}" var="url1">--%>
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12"  >
                                        ...
                                        <div class="col-md-12 col-sm-12 col-xs-12">
                                            <form:input path="picFile2" id="picFile2"
                                                        ...
                                                        required="" type="file" multiple="multiple"/>
                                                <%--<c:forEach items="${reporttestForm.picUrl2}" var="url1">--%>
                                                <%--<div><img src="${url1}" class='file-preview-image kv-preview-data  col-md-2 col-sm-1 col-xs-12'--%>
                                                <%--style='width:20%;height:20%;max-width:100%;max-height:100%;margin-bottom: 20px;' alt='' title=''></div>--%>
                                                <%--</c:forEach>--%>
                                        </div>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <form:input path="detail" id="detail"  required="" name="detail" type="hidden"
                                                    ...
                                                    value="${reporttestForm.detail}"></form:input>
                                        <div class="x_content">
                                            <div id="alerts"></div>
                            ...
                            <div class="form-group">
                                <div class="col-md-6 col-md-offset-3">
                                    <a class="btn btn-primary" href="/admin/reporttest/list/" style="width: 100px;">キャンセル</a>
                                    <form:input type="hidden" path="id" value="${reporttestForm.id}"/>
                                    <form:input type="hidden" path="picUrl1" value="${reporttestForm.picUrl1}"/>
                                    <form:input type="hidden" path="picUrl2" value="${reporttestForm.picUrl2}"/>
...
<script>
    ...
    $('#picFile1').fileinput({
        ...
        <c:if test="${reporttestForm.picUrl1 != null && reporttestForm.picUrl1 != ''}">
    ...
    $('#picFile2').fileinput({
        'language':'ja', 'showClose': true, 'showCaption':false,'showRemove':false,'dropZoneTitle':'', 'showUpload': false, 'previewFileType': 'any', 'autoReplace': true,"minImageWidth":500,"maxImageWidth":500,"minImageHeight":500,"maxImageHeight":500
        <c:if test="${reporttestForm.picUrl2 != null && reporttestForm.picUrl2 != ''}">
        , 'uploadUrl': null, 'initialPreview': [
            <c:forEach items="${reporttestForm.picUrl2}" var="url2">
