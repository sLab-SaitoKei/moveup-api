                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                ...
                                <form:form id="userForm" modelAttribute="ramenForm"  enctype="multipart/form-data"
                                           action="${pageContext.request.contextPath}/admin/ramen/update/"
                                           class="form-horizontal form-label-left">

                                <div class="item form-group">
                                    <div>
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12">カテゴリ <span
                                                class="required">*</span>
                                        </label>
                                        <div class="col-md-1 col-sm-6 col-xs-12">
                                            <form:select path="type" required="required" data-validate-minmax="10,100"
                                                         class="form-control col-md-7 col-xs-12">
                                                <c:if test="${ramenForm.type ==1}">
                                                    <form:option value="1">EVENT</form:option>
                                                    <form:option value="2">MOVEUP</form:option>
                                                    <form:option value="3">NEWS</form:option>
                                                </c:if>
                                                <c:if test="${ramenForm.type ==2}">
                                                    <form:option value="1">EVENT</form:option>
                                                    <form:option value="2">MOVEUP</form:option>
                                                    <form:option value="3">NEWS</form:option>
                                                </c:if>
                                                <c:if test="${ramenForm.type ==3}">
                                                    <form:option value="1">EVENT</form:option>
                                                    <form:option value="2">MOVEUP</form:option>
                                                    <form:option value="3">NEWS</form:option>
                                                </c:if>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <form:input path="title" id="title" class="form-control col-md-7 col-xs-12"
                                                    ...
                                                    value="${ramenForm.title}"/>
                                    </div>
                                </div>
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12">詳細抜粋 <span
                                            class="required">*</span>
                                    </label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <form:input path="excerpt" type="text" id="excerpt" name="excerpt" required="required"
                                                    class="form-control col-md-7 col-xs-12"
                                                    value="${ramenForm.excerpt}"/>
                                    </div>
                                </div>
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12"  >
                                        <div class="col-md-12 col-sm-12 col-xs-12">
                                            <label class=" col-md-5 col-sm-3 col-xs-12" style="text-align: left;padding:0 5px;" >TOP画像<span
                                                    class="required"></span>
                                            </label>
                                        ...
                                        <div class="col-md-12 col-sm-12 col-xs-12">
                                            ...
                                            <%--<c:forEach items="${ramenForm.picUrl1}" var="url1">--%>
                                ...
                                <div class="item form-group" style="margin-top: 30px;">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12"  >
                                        <div class="col-md-12 col-sm-12 col-xs-12">
                                            <label class=" col-md-5 col-sm-3 col-xs-12" style="text-align: left;padding:0 5px;">FOOT画像<span
                                                    class="required"></span>
                                            </label>
                                            <label class=" col-md-7 col-sm-3 col-xs-12" style="text-align: right">解像度: 500 X 500</label>
                                        </div>
                                        <div class="col-md-12 col-sm-12 col-xs-12">
                                            <form:input path="picFile2" id="picFile2"
                                                        ...
                                                        required="" type="file" multiple="multiple"/>
                                            <%--<c:forEach items="${ramenForm.picUrl2}" var="url1">--%>
                                                <%--<div><img src="${url1}" class='file-preview-image kv-preview-data  col-md-2 col-sm-1 col-xs-12'--%>
                                                          <%--style='width:20%;height:20%;max-width:100%;max-height:100%;margin-bottom: 20px;' alt='' title=''></div>--%>
                                            <%--</c:forEach>--%>
                                        </div>
                                ...
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12">詳細 <span
                                            class="required">*</span>
                                    </label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <form:input path="detail" id="detail"  required="" name="detail" type="hidden"
                                                     ...
                                                     value="${ramenForm.detail}"></form:input>
                                        <div class="x_content">
                                            <div id="alerts"></div>
                            ...
                            <div class="form-group">
                                <div class="col-md-6 col-md-offset-3">
                                    <a class="btn btn-primary" href="/admin/ramen/list/" style="width: 100px;">キャンセル</a>
                                    <form:input type="hidden" path="id" value="${ramenForm.id}"/>
                                    <form:input type="hidden" path="picUrl1" value="${ramenForm.picUrl1}"/>
                                    <form:input type="hidden" path="picUrl2" value="${ramenForm.picUrl2}"/>
...
<script>
    ...
    $('#picFile1').fileinput({
        ...
        <c:if test="${ramenForm.picUrl1 != null && ramenForm.picUrl1 != ''}">
    ...
    $('#picFile2').fileinput({
        'language':'ja', 'showClose': true, 'showCaption':false,'showRemove':false,'dropZoneTitle':'', 'showUpload': false, 'previewFileType': 'any', 'autoReplace': true,"minImageWidth":500,"maxImageWidth":500,"minImageHeight":500,"maxImageHeight":500
        <c:if test="${ramenForm.picUrl2 != null && ramenForm.picUrl2 != ''}">
        , 'uploadUrl': null, 'initialPreview': [
            <c:forEach items="${ramenForm.picUrl2}" var="url2">
