                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                <br/>
                                <form:form modelAttribute="reporttestForm" id="userForm" enctype="multipart/form-data"
                                           class="form-horizontal form-label-left" action="${pageContext.request.contextPath}/admin/reporttest/regist/">
...
<script>
    ...
    $('#picFile1').fileinput({
        ...
        <%--"<img src='${reporttestForm.picUrl1}' class='file-preview-image kv-preview-data' stype='width:auto;height:auto;max-width:100%;max-height:100%;' alt='Desert' title='Desert'>"--%>
        <%--]--%>
        <%--</c:if>--%>
    });
    $('#picFile2').fileinput({
        ...
        <%--, 'uploadUrl': null, 'initialPreview': [--%>
        <%--"<img src='${reporttestForm.picUrl2}' class='file-preview-image kv-preview-data' stype='width:auto;height:auto;max-width:100%;max-height:100%;' alt='Desert' title='Desert'>"--%>
        <%--]--%>
        <%--</c:if>--%>
    });
